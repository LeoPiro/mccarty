  ...
  const images = [
    {
      ...
      alt: "Pharmaceutical and medical manufacturing production space constructed in Devens, Massachusetts"
    },
    {
      src: "/media/projects/smc/office.jpg",
      alt: "Advanced manufacturing and assembly area at the SMC production facility in Devens, Massachusetts"
    },
    {
      src: "/media/projects/smc/hall.jpg",
      alt: "Medical manufacturing production area inside the SMC facility in Devens, Massachusetts"
    }
  ];
      ...
      <main className="pt-16">
        ...
        <section ref={heroRef} className="relative h-[90vh] w-full overflow-hidden">
          ...
          >
            <Image
              src="/media/projects/smc/hall.jpg"
              alt="Cleanroom manufacturing facility expansion for SMC Ltd in Devens, Massachusetts"
              fill
          ...
          <div className="relative z-10 mx-auto h-full max-w-7xl px-6 py-12">
            ...
            <motion.div
              ...
              style={{ y: factsY }}
              className="absolute top-[360px] left-1/2 -translate-x-1/2 md:hidden bg-mccarty-dark/25 backdrop-blur-md text-white rounded-lg p-6 w-[320px] shadow-2xl"
            ...
            >
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-3 md:mb-4">Cleanroom &amp; Pharmaceutical Manufacturing Facility Construction – Devens, Massachusetts</h1>
              <p className="text-xl md:text-2xl">
                A decade-long partnership delivering phased cleanroom and advanced manufacturing facilities.
              </p>
            </motion.div>
          </div>
        </section>
          ...
          <div className="space-y-12">
            <div>
              ...
              <div className="prose prose-lg max-w-none space-y-4 text-mccarty-medium leading-relaxed">
                <p>
                  SMC, Ltd. is one of McCarty Companies&apos; longest-standing clients, with a partnership that began in early 2015 when SMC leased the former Gillette Building at 18 Independence Drive in Devens, Massachusetts. Since that time, McCarty Engineering and McCarty Associates have completed a series of complex, phased cleanroom and pharmaceutical manufacturing facility construction projects to support SMC&apos;s continued growth in medical-grade manufacturing, cleanroom production, and pharmaceutical operations.
                </p>
                <p>
                ...
                <p>
                  In 2018, McCarty Companies completed two additional phased buildouts within Cleanroom 2. The middle one-third of the space was constructed as an assembly area with a 16-foot ceiling height and bridge cranes installed to allow flexibility between assembly and molding operations. Later that year, the front one-third of Cleanroom 2 was also completed as assembly space, featuring a 22-foot ceiling height and bridge cranes to further expand production capability.
                </p>
                <p>
                  Expansion continued in 2020 with the construction of Cleanroom 3, located adjacent to Cleanroom 2. The front two-thirds of the space was built with a 22-foot ceiling height and preparatory work completed for future bridge crane installation. The rear one-third was developed as white space with an office mezzanine above. In 2021, McCarty Companies completed two major projects simultaneously: Cleanroom 4, a 15,400 SF Class 8 assembly room, and the Controlled Space addition, a 3,100 SF building addition designed exclusively for pharmaceutical storage.
                </p>
                <p>
                  After fully building out the available space, SMC once again engaged McCarty Engineering and McCarty Associates to locate, perform due diligence, design, permit, and construct a new facility at 11 Grant Road, Devens, Massachusetts for Werfen.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="relative w-full min-h-[80vh] flex items-center justify-center overflow-hidden">
          <div className="absolute inset-0">
            <Image
              src="/media/projects/smc/window.jpg"
              alt="Automated manufacturing and cleanroom production equipment inside SMC facility in Devens, Massachusetts"
              fill
        ...
        <section className="mx-auto max-w-6xl px-6 py-16">
          ...
          >
            ...
            <p className="prose prose-lg max-w-none text-mccarty-medium leading-relaxed mb-8">
              Werfen&apos;s relocation has freed approximately 130,000 SF of space at the initial site, enabling the next phase of SMC&apos;s long-term growth. McCarty Engineering and McCarty Associates have again been selected to design, permit, and construct significant new manufacturing and support space, with the current project slated for completion at the end of 2026.
            </p>
            <div className="grid md:grid-cols-2 gap-8">
