...
export default function WerfernProjectPage() {
  ...
  const images = [
    {
      ...
      alt: "Commercial site development and construction of the Werfen pharmaceutical warehouse in Devens, Massachusetts"
    },
    {
      src: "/media/Werfern pre construction.JPG",
      alt: "Structural steel and underground utility pipes staged during construction of the Werfen pharmaceutical warehouse in Devens, Massachusetts"
    },
    {
      src: "/media/werfern_interior_image.JPG",
      alt: "Open warehouse interior at the Werfen pharmaceutical distribution facility in Devens, Massachusetts"
    },
    {
      src: "/media/Werfern_fridge_exterior.JPG",
      alt: "Interior of the Werfen pharmaceutical distribution warehouse in Devens, Massachusetts"
    }
  ];
  ...
  return (
    <>
      ...
      <main className="pt-16">
        ...
        <section ref={heroRef} className="relative h-[90vh] w-full overflow-hidden">
          ...
          >
            <Image
              ...
              alt="Pharmaceutical warehouse and distribution facility constructed by McCarty Companies in Devens, Massachusetts"
              fill
              className="object-cover object-left md:object-center animate-pan"
              priority
            />
          </motion.div>
          ...
          <div className="relative z-10 mx-auto h-full max-w-7xl px-6 py-12">
            {/* Project Facts Box - Starts Below Text on Mobile with Parallax */}
            <motion.div
              initial={{ opacity: 0, y: 24 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.6, ease: "easeOut", delay: 0.3 }}
              style={{ y: factsY }}
              className="absolute top-[280px] left-1/2 -translate-x-1/2 lg:hidden bg-mccarty-dark/25 backdrop-blur-md text-white rounded-lg p-6 w-[320px] shadow-2xl"
            ...
            >
              ...
              <div className="space-y-3">
                ...
                <div className="border-b border-white/10 pb-2">
                  ...
                  <p className="text-sm font-medium">232,320 SF</p>
                </div>
                
                <div className="border-b border-white/10 pb-2">
                  <p className="text-xs uppercase mb-1 opacity-70">Status</p>
                  <p className="text-sm font-medium">Completed 2025</p>
                </div>
            ...
            <motion.div
              ...
              transition={{ duration: 0.6, ease: "easeOut", delay: 0.3 }}
              style={{ y: factsY }}
              className="hidden lg:block absolute top-1/2 -translate-y-1/2 right-6 bg-mccarty-dark/25 backdrop-blur-md text-white rounded-lg p-8 w-[320px] shadow-2xl"
              suppressHydrationWarning
            >
            ...
            {/* Title Section - Top on Mobile, Bottom Left on Desktop */}
            <motion.div
              initial={{ opacity: 0, y: 24 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.6, ease: "easeOut", delay: 0.2 }}
              className="absolute top-6 lg:bottom-16 left-6 text-white max-w-2xl"
              suppressHydrationWarning
            >
              ...
              <h1 className="text-4xl lg:text-5xl font-bold mb-3 lg:mb-4">Werfen Pharmaceutical Distribution Facility in Devens, MA</h1>
              <p className="text-xl lg:text-2xl">
                A 232,320 SF state-of-the-art pharmaceutical warehousing and distribution facility engineered and constructed through McCarty&apos;s integrated design-build model.
              </p>
            </motion.div>
          </div>
        </section>
          ...
          <div className="space-y-12">
              <div>
                ...
                <div className="prose prose-lg max-w-none space-y-4 text-mccarty-medium leading-relaxed">
                  <p>
                    This 232,320 SF pharmaceutical warehousing and distribution facility in Devens, Massachusetts was engineered and constructed to meet the strict environmental and operational demands of modern pharmaceutical logistics. Designed by McCarty Engineering and constructed by McCarty Associates, the project reflects the strength of our fully integrated design-build approach — combining civil engineering precision, site development expertise, and construction management under one coordinated team.
                  </p>
                  <p>
                    Built with a 45-foot clear height and a 50 x 66 foot column spacing, the structure provides optimal flow throughout the building for racking and clear movement paths. A key feature is its 30,000 SF walk-in cooler with a soaring 40-foot ceiling height, purpose-built for large-volume temperature-controlled pharmaceutical storage. The facility&apos;s structural backbone includes 7,200 cubic yards of concrete, 266 tons of reinforcing rod, and 1,310 tons of structural steel.
                  </p>
                  <p>
        ...
        <section className="relative w-full min-h-[80vh] flex items-center justify-center overflow-hidden" aria-label="Industrial refrigeration unit used for temperature-controlled storage at the Werfen pharmaceutical warehouse in Devens, Massachusetts">
          {/* Video Background */}
          <video
            ref={videoRef}
            autoPlay
        ...
        <section className="bg-mccarty-dark text-white py-20">
          <div className="mx-auto max-w-6xl px-6 text-center">
            ...
            <p className="text-xl text-mccarty-light mb-8 max-w-2xl mx-auto">
              McCarty Companies delivers integrated solutions for complex commercial and industrial developments across Massachusetts and New England.
            </p>
