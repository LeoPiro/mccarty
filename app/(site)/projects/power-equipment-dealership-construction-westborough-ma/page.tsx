  ...
  const images = [
    {
      ...
      alt: "Interior showroom displaying outdoor power equipment at the Boston Lawnmower dealership in Westborough, Massachusetts"
    },
    {
      src: "/media/projects/boston-lawnmower/showroom-mowers.jpg",
      alt: "Retail showroom with lawn and power equipment on display inside the Boston Lawnmower dealership in Westborough, Massachusetts"
    },
    {
      src: "/media/projects/boston-lawnmower/showroom-ariens.jpg",
      alt: "Customer showroom area with power equipment displays at the Boston Lawnmower dealership in Westborough, Massachusetts"
    },
    {
      src: "/media/projects/boston-lawnmower/showroom-gravely.jpg",
      alt: "Front desk and customer service area inside the Boston Lawnmower equipment showroom in Westborough, Massachusetts"
    },
    {
      src: "/media/projects/boston-lawnmower/counter.jpg",
      alt: "Service counter and customer area inside the Boston Lawnmower dealership in Westborough, Massachusetts"
    },
    {
      src: "/media/projects/boston-lawnmower/construction.jpg",
      alt: "Utility piping and site infrastructure installation during construction of the Boston Lawnmower dealership in Westborough, Massachusetts"
    }
  ];
      ...
      <main className="pt-16">
        ...
        <section ref={heroRef} className="relative h-[90vh] w-full overflow-hidden">
          ...
          >
            <Image
              ...
              alt="Retail power equipment dealership constructed in Westborough, Massachusetts by McCarty Companies"
              fill
          ...
          <div className="relative z-10 mx-auto h-full max-w-7xl px-6 py-12">
            ...
            >
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-3 md:mb-4">Retail Power Equipment Dealership Construction – Westborough, Massachusetts</h1>
              <p className="text-xl md:text-2xl">
                A 24,500 SF commercial dealership facility designed and constructed for Boston Lawnmower
              </p>
            </motion.div>
          </div>
        </section>
          ...
          <div className="space-y-12">
            <div>
              ...
              <div className="prose prose-lg max-w-none space-y-4 text-mccarty-medium leading-relaxed">
                <p>
                  This 24,500 SF retail power equipment dealership was designed, permitted, and constructed for Boston Lawnmower on a previously vacant, undeveloped site in Westborough, Massachusetts. The project was delivered through the integrated design-build approach of McCarty Companies, with civil engineering and permitting services provided by McCarty Engineering and construction completed by McCarty Associates. The project includes a primary retail and service facility along with a free-standing storage building, delivering a highly functional layout tailored to sales, service, and equipment storage.
                </p>
                <p>
                ...
                <p>
                  Site development scope included full utility connections, landscaping, stormwater management systems, and construction of 61 parking spaces. The project received Site Plan Approval from the Town of Westborough Planning Board and was constructed between February 2024 and January 2025 by McCarty Associates, following civil engineering and permitting coordination by McCarty Engineering.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="relative w-full min-h-[80vh] flex items-center justify-center overflow-hidden">
          <div className="absolute inset-0">
            <Image
              src="/media/projects/boston-lawnmower/showroom-overview.jpg"
              alt="Boston Lawnmower retail dealership building in Westborough, Massachusetts constructed by McCarty Companies"
              fill
