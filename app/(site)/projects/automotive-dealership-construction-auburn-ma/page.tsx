...
export default function PatrickMotorGroupPage() {
  ...
  const mazdaImages = [
    { src: "/media/projects/patrick-motor/patrick-mazda-aerial.jpg", alt: "Aerial view of Patrick Mazda dealership constructed by McCarty Companies in Auburn, Massachusetts" },
    { src: "/media/projects/patrick-motor/patrick-mazda-exterior-sunset.jpg", alt: "Patrick Mazda dealership exterior at sunset in Auburn, Massachusetts" },
    { src: "/media/projects/patrick-motor/patrick-mazda-exterior-night.jpg", alt: "Patrick Mazda dealership exterior at night in Auburn, Massachusetts" },
    { src: "/media/projects/patrick-motor/patrick-mazda-front-dusk.jpg", alt: "Patrick Mazda dealership front entrance at dusk in Auburn, Massachusetts" },
  ];
    ...
    <>
      ...
      <main className="pt-16">
        ...
        <section ref={heroRef} className="relative h-[90vh] w-full overflow-hidden">
          ...
          >
            <Image
              src="/media/projects/patrick-motor/patrick-mazda-aerial.jpg"
              alt="Aerial view of Patrick Mazda dealership constructed by McCarty Companies in Auburn, Massachusetts"
              fill
          ...
          <div className="relative z-10 mx-auto h-full max-w-7xl px-6 py-12">
            ...
            <motion.div
              ...
              style={{ y: factsY }}
              className="absolute top-[280px] left-1/2 -translate-x-1/2 md:hidden bg-mccarty-dark/25 backdrop-blur-md text-white rounded-lg p-6 w-[320px] shadow-2xl"
            ...
            >
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-3 md:mb-4">Automotive Dealership Construction – Auburn, Massachusetts</h1>
              <p className="text-xl md:text-2xl">
                A series of commercial automotive dealership construction projects for Patrick Motor Group
              </p>
            </motion.div>
          </div>
        </section>
          ...
          <div className="space-y-12">
            <div>
              ...
              <div className="prose prose-lg max-w-none space-y-4 text-mccarty-medium leading-relaxed">
                <p>
                  McCarty Companies has partnered with the Patrick Motor Group on a series of complex automotive dealership projects in Auburn, Massachusetts, delivering new construction, phased renovations, and supporting facilities to meet the group&apos;s continued growth. These projects were delivered through the integrated design-build approach of McCarty Companies, with site engineering and permitting services provided by McCarty Engineering and construction services completed by McCarty Associates. Across multiple sites, these projects required extensive coordination with national automotive brand consultants, local and state permitting authorities, and ongoing dealership operations.
                </p>
                <p>
                  Scope across the Auburn campuses included new ground-up dealership construction, multi-brand renovations and expansions, large-scale site development, and the creation of a dedicated reconditioning and inventory storage facility. Each project was carefully phased and executed to maintain active dealership operations while meeting evolving brand standards and customer experience requirements.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="relative h-[50vh] w-full overflow-hidden">
          <Image
            src="/media/projects/patrick-motor/patrick-mazda-exterior-sunset.jpg"
            alt="Patrick Mazda dealership exterior at sunset in Auburn, Massachusetts"
            fill
        ...
        <section className="mx-auto max-w-6xl px-6 py-16">
          <div className="grid md:grid-cols-2 gap-12">
            <div>
              ...
              <div className="prose prose-lg max-w-none space-y-4 text-mccarty-medium leading-relaxed">
                <p>
                  McCarty Engineering and McCarty Associates provided site design, permitting, and construction services for a new 18,000 SF Patrick Mazda dealership on a 5.62-acre site in Auburn, Massachusetts. The project involved significant site engineering challenges, including major elevation changes and extensive earthwork, while coordinating closely with Mazda&apos;s national design consultants to deliver a prototypical dealership facility.
                </p>
                <p>
                  The completed building includes a modern showroom, service drive-through, and twelve service bays, supported by extensive on-site parking and infrastructure improvements. Construction began in October 2019 and was completed in January 2025 by McCarty Associates, following civil engineering and site design by McCarty Engineering under the McCarty Companies integrated delivery model.
                </p>
              </div>
            </div>
        ...
        <section className="relative h-[50vh] w-full overflow-hidden">
          <Image
            src="/media/projects/patrick-motor/patrick-volvo-vw-exterior.jpg"
            alt="Patrick Volvo and Volkswagen dealership exterior in Auburn, Massachusetts"
            fill
            className="object-cover"
          />
          <div className="absolute inset-0 bg-black/40" />
        ...
        <section className="mx-auto max-w-6xl px-6 py-16">
          <div className="grid md:grid-cols-2 gap-12">
            <div>
              ...
              <div className="prose prose-lg max-w-none space-y-4 text-mccarty-medium leading-relaxed">
                <p>
                  This project included renovations, additions, and expansions to an existing two-brand automotive dealership originally constructed in 1995. McCarty Associates coordinated a highly phased construction approach, allowing the Volkswagen dealership to remain fully operational while half of the building was renovated and expanded at a time. Site engineering and permitting support were provided by McCarty Engineering.
                </p>
                <p>
        ...
        <section className="mx-auto max-w-6xl px-6 py-16">
          ...
          >
            ...
            <p className="prose prose-lg max-w-none text-mccarty-medium leading-relaxed mb-8">
              McCarty Companies is currently under contract with the Patrick Motor Group for the design and permitting of a new Subaru dealership in Shrewsbury, Massachusetts, continuing the long-standing partnership across the region.
            </p>
            <div className="bg-gray-50 rounded-lg p-8">
              ...
              <ul className="space-y-3 text-mccarty-medium">
                ...
                <li>• Site plan preparation currently underway by McCarty Engineering</li>
                <li>• Design and permitting targeted for completion by Q4 2026</li>
                <li>• Anticipated construction start in early 2027 with McCarty Associates</li>
              </ul>
            </div>
          </motion.div>
        </section>
