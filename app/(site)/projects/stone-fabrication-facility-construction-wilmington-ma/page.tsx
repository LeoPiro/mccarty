...
export default function GerrityStoneProjectPage() {
  ...
  const images = [
    ...
    },
    {
      ...
      alt: "Interior production space inside the Gerrity Stone fabrication facility in Wilmington, Massachusetts"
    },
    {
      src: "/media/projects/gerrity-stone/interior-3.jpg",
      alt: "Stone fabrication workspace and material processing area at the Gerrity Stone facility in Wilmington, Massachusetts"
    }
  ];
      ...
      <main className="pt-16">
        ...
        <section ref={heroRef} className="relative h-[90vh] w-full overflow-hidden">
          ...
          >
            <Image
              ...
              alt="Stone fabrication facility constructed for Gerrity Stone in Wilmington, Massachusetts"
              fill
          ...
          <div className="relative z-10 mx-auto h-full max-w-7xl px-6 py-12">
            ...
            <motion.div
              ...
              style={{ y: factsY }}
              className="absolute top-[330px] left-1/2 -translate-x-1/2 md:hidden bg-mccarty-dark/25 backdrop-blur-md text-white rounded-lg p-6 w-[320px] shadow-2xl"
            ...
            >
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-3 md:mb-4">Stone Fabrication Facility Construction – Wilmington, Massachusetts</h1>
              <p className="text-xl md:text-2xl">
                A 44,400 SF industrial fabrication and showroom facility constructed for Gerrity Stone
              </p>
            </motion.div>
          </div>
        </section>
        ...
        <section className="relative w-full min-h-[80vh] flex items-center justify-center overflow-hidden">
          <div className="absolute inset-0">
            <Image
              src="/media/projects/gerrity-stone/interior-3.jpg"
              alt="Stone fabrication production facility with overhead crane system in Wilmington, Massachusetts"
              fill
