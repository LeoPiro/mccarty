...
export function HeresHowSection() {
  return (
    <div className="mx-auto max-w-6xl px-6 py-8">
      ...
      >
        <h2 className="text-4xl md:text-5xl font-bold text-left text-mccarty-dark mb-6">Here&apos;s how</h2>
          ...
          <div className="flex-1">
            <div className="prose prose-neutral max-w-none">
              ...
              <p className="text-lg leading-relaxed text-mccarty-medium mt-6">
                For more than 40 years, we&apos;ve helped businesses, developers, and institutions navigate permitting, site development, and large-scale commercial construction with precision and accountability.
              </p>
            </div>
          </div>
